...
let UserService = class UserService {
    ...
    async create(createUserDto) {
        ...
        if (!userExisting) {
            throw new common_1.ConflictException(`E-mail ${userExisting} already exists`);
        }
    ...
    async updateUser(id, createUserDto) {
        ...
        if (createUserDto.email && createUserDto.email !== user.email) {
            ...
            if (existing) {
                throw new common_1.ConflictException(`This is e-mail ${createUserDto.email} existing`);
            }
        }
